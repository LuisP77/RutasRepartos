...
{  
  $query="SELECT id, nom, tlf, actiu, vacances, baixa_laboral FROM lliuradors WHERE actiu = false";
...
$sec = "repartidores"; $pagact = "/gestio/lliuradors/repartidores/repartidores_noact.php";
