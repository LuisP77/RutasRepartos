...
{  
  $query="SELECT id, nom, tlf, actiu, vacances, baixa_laboral FROM lliuradors WHERE vacances = true";
...
$sec = "repartidores"; $pagact = "/gestio/lliuradors/repartidores/repartidores_vac.php";
