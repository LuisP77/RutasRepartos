...
{  
  $query="SELECT id, nom, tlf, actiu, vacances, baixa_laboral FROM lliuradors WHERE baixa_laboral = true";
  ...
  if (!$result_set) {
	...
	$html = <<<HTML
      ...
      <th>Vacances</th>
	  <th>Baixa Laboral</th>
      <th style="text-align:center" style="text-align:center">Editar</th>
...
$sec = "repartidores"; $pagact = "/gestio/lliuradors/repartidores/repartidores_baj.php";
