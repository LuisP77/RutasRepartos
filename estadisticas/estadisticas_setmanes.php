...
/********************************************************************************************************************/
  ...
  $sec = "estadisticas"; $pagact = "estadisticas_setmanes.php"; 
  
  $today = date("Y-m-d");
  $year = date('Y');
  $week = date('W');
  $fecha_inicio  = date('Y-m-d', strtotime($year . 'W' . str_pad($week , 2, '0', STR_PAD_LEFT)));
...
-->   
  ...
  <div class="container-fluid" style="display:none">
	...
	<div class="row">
		<div id="chart_furgonetas" style="display:none"></div>
	</div>
