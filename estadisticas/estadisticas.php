...
/********************************************************************************************************************/
  ...
  $sec = "estadisticas"; $pagact = "estadisticas.php"; 
...
-->   
  ...
  <div class="container-fluid" style="display:none">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab" href="#menu_tablas">Taules</a>
			<li><a data-toggle="tab" href="#menu_graficos">Gràfics</a>
		</ul>
		
		<div class="tab-content">
		
		<div id="menu_tablas" class="tab-pane fade in active">
		...
		<div id="menu_graficos" class="tab-pane fade">
