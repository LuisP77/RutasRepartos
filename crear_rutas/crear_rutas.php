...
$html = <<<HTML
	  <table id="principal" class="cell-border display compact table-responsive" style="font-size:16px" 
	         onmouseleave="recarga_flechas_xeditable()">
      <thead style="background-color:rgb(150,150,255); font-size:80%">
		<tr>
			...
			<th style="display:none">ascensor</th>
			<th style="display:none">SEC</th>
			<th style="display:none">REF</th>
			<th style="display:none">F/V</th>
			<th style="display:none">id_usuari</th>
			<th style="display:none">tlf</th>
			<th style="display:none">líneas</th>
			<th style="display:none">NC</th>
	...
	<div class="panel panel-primary" id="panel_ruta_$n_ruta">
		...
		<div class="panel-heading" style="padding-bottom:0px">
			...
			<div class="row">
				...
				<div class="col-xs-1">
					<button type="button" class="btn btn-warning" onclick="abrir_dialogo_repartidores($n_ruta)" style="position:absolute; left:-10px;">
				...
				<div class="col-xs-1">
					<button type="button" class="btn btn-warning" onclick="abrir_dialogo_furgonetas($n_ruta)" style="position:absolute; left:-10px;">
...
/********************************************************************************************************************/
  ...
  $sec = "crear_rutas"; $pagact = "crear_rutas.php"; 
	...
	<!-- -------------------------------------------------------------------------------------------------------- -->
	  <div class="row">
		...
		<div style="display:table-cell; font-size:16px" align="right" class="col-sm-3 col-xs-3">
			<br><br>
			<strong>Data:</strong>  
			<input id="fecha" onchange= "updateFecha(this.value)" type="date" required="required" min="<?php echo $hoy?>" max="<?php echo $prox_semana?>" 
