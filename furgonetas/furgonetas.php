...
{  
  $query="SELECT id, nom, matricula, marca, model, volum, llarg, ample, alt, taller, actiu FROM furgonetes WHERE lloguer=false";
...
$sec = "furgonetas"; $pagact = "/gestio/lliuradors/furgonetas/furgonetas.php";
