...
/* ******************************************************************************************* */
	function updateFecha(fecha){
		window.location.href='historic.php?fecha='+fecha;
	}  
/* ******************************************************************************************* */
	...
	// Escribir Tablas Rutas	
		for (i = 1; i < N; i++) {        // i --> 0 el title y N el footer!!
			...
			if((valor!="0")&&(valor!=null)){
				...
				celda_flecha_arriba.style.display = 'none';
				...
				celda_flecha_abajo.style.display = 'none';
...
/* ******************************************************************************************* */
	function dataTables(){
	  ...
	  var tabla_principal = $('#principal_NOSELECCIONAR').DataTable(
      {
        responsive: true,
		paging: true,
		searching: true,
